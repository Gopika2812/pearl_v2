...
const CustomerGroupAddModal = ({ isOpen, onClose, onSave, branchId, editingItem }) => {
  ...
  const handleSave = (e) => {
    e.preventDefault();
    if (!groupName) {
      alert("Please fill in the customer group name");
      return;
    }
  ...
  const handleBulkUpload = async (e) => {
    ...
    try {
      const res = await fetch(
        `${API_BASE}/customer-groups/bulk-upload`,
        {
          method: "POST",
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
      <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <div className="bg-primary p-4 text-white">
          <h3 className="text-xl font-bold">Customer Group</h3>
        </div>
        ...
        <div className="p-6 space-y-4">
          ...
          <form onSubmit={handleSave} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="e.g., Premium Customers, Bulk Buyers, VIP Clients"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Optional: Add group details"
                className="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-primary focus:outline-none transition"
                rows="2"
              />
            </div>
          ...
          {/* Bulk Upload */}
          <div
            onClick={() => document.getElementById("customerGroupBulkUpload").click()}
