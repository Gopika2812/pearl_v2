              ...
              <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-top: 15px;">
                ...
                <div style="flex: 1; padding-right: 20px;">
                  ${(() => {
                    ...
                    return `
                      <div style="font-size: 10px; color: #000; margin-bottom: 4px;">The below ordered items were not sent due to stock unavailability:</div>
                ...
                <div style="display:flex; flex-direction:column; align-items:center;">
                   <img src="https://quickchart.io/qr?size=150&text=${encodeURIComponent(`upi://pay?pa=${previewData?.seller?.gpayNo || currentBranch?.gpayNo || ''}&pn=${previewData?.seller?.name || 'Pearl Agency'}&cu=INR`)}" style="width:25mm; height:25mm;" alt="GPay QR"/>
          ...
          <div class="page">
            ...
            return Object.entries(hsnMap).map(([hsn, data]) => `
              ...
              `<div style="font-size: 11px;">CGST: <strong>₹${(previewData?.totalTax?.cgst || 0).toFixed(2)}</strong></div>
                  ...
                  ${(previewData?.roundingOff != null && previewData.roundingOff !== 0) ? `<div style="font-size: 11px;">Rounding Off: <strong>${previewData.roundingOff > 0 ? '+' : ''}₹${previewData.roundingOff.toFixed(2)}</strong></div>` : ""}
