...
export const PAGE_CONFIG = [
    ...
    items: [
      ...
      },
      {
        id: "delivery-dropdown", name: "Delivery", icon: "truck", isDropdown: true, subItems: [
          { id: "delivery-flow", name: "Pick & Delivery Completed", path: "/branch/delivery-flow", icon: "list" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "incentive-intelligence", name: "Incentive Intelligence", path: "/branch/incentive-intelligence", icon: "chart" },
    ]
  },
  {
    ...
    items: [
      {
        id: "physical-stock-dropdown", name: "Stock Verification", icon: "inventory", isDropdown: true, subItems: [
          { id: "physical-stock-entry", name: "Stock Journal Entry", path: "/branch/physical-stock", icon: "add", permissionFields: ["productName", "productGroupName", "systemQty", "damagedQty", "expiredQty", "physicalQty", "inward", "outward", "mrp", "batch", "expiryDate", "checkedBy", "status", "action_save", "action_approve"] },
    ...
    items: [
      {
        id: "hr-payroll-dropdown", name: "HR Management", icon: "users", isDropdown: true, subItems: [
          ...
          { id: "attendance-report", name: "All Attendance Records", path: "/branch/hr/attendance-report", icon: "check" },
