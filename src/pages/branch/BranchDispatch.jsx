              ...
              {loadedProducts && (
                <div className="mb-8">
                  ...
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      {[...loadedProducts.data].sort((a, b) => a.name.localeCompare(b.name)).map((product, idx) => (
                        <tr key={idx}>
                          <td className="border border-gray-300 px-4 py-3 font-black text-[16px] text-gray-900 uppercase">
                            {product.name}
                          </td>
                          <td className="border border-gray-300 px-4 py-3 text-right font-bold text-[14px] text-gray-800">
                            {product.hsn || "-"}
                          </td>
                          <td className="border border-gray-300 px-4 py-3 text-right font-black text-[18px] text-gray-900">
