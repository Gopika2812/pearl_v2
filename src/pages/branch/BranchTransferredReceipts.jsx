             ...
             <table className="w-full text-left border-collapse">
               <thead>
                 <tr className="bg-slate-50/50 border-b border-slate-100">
                   <th className="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest">Receipt Info</th>
                   ...
                   <th className="px-8 py-6 text-[10px] font-black text-slate-400 uppercase tracking-widest text-right">Net Amount</th>
                       ...
                       <tr className="hover:bg-indigo-50/30 transition-colors">
                         <td className="px-8 py-6">
                            <div>
                               ...
                               <div className="text-[10px] font-bold text-slate-400 uppercase">Receipt Date: {new Date(r.date).toLocaleDateString()}</div>
                            </div>
                         </td>
                         <td className="px-8 py-6">
                         ...
                         <td className="px-8 py-6 text-right">
                            <span className="text-sm font-black text-indigo-600">₹{r.netAmount?.toLocaleString()}</span>
                         </td>
